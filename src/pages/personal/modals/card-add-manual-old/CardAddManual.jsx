...
const CardAddManual = () => {
  ...
  const submitting = () => {
    ...
    postingData(`${ httpEndpoint }/${topicName}`, { userId, topicId: topic._id, topicLang, mode: 'manual', content: {'root word': formContent['root word'], variations: formContent.variations}} )
      .then((data) => {
        afterSubmitReset();
